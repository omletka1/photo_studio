...
<div class="dashboard-content">
    ...
    <header class="page-header">
        ...
        <p class="page-subtitle">Управление профилем и история участия</p>
    </header>
            ...
            <div class="profile-grid">
                <div class="profile-avatar">
                    <?php if (!empty($user->avatar)): ?>
                        <a href="<?= Yii::getAlias('@web/' . $user->avatar) ?>"
                           data-lightbox="avatar-<?= $user->id ?>"
                           data-title="Аватар: <?= Html::encode($user->surname . ' ' . $user->name) ?>"
                           class="avatar-link">
                            <img src="<?= Yii::getAlias('@web/' . $user->avatar) ?>" alt="Аватар" class="avatar-img">
                ...
                <div class="profile-details">
                    <h2 class="profile-name"><?= Html::encode($user->surname . ' ' . $user->name) ?></h2>
                    ...
                    <div class="profile-meta">
                        ...
                        <div class="meta-row">
                            ...
                            <span class="meta-muted">@<?= Html::encode($user->username) ?></span>
                        </div>
                    </div>
                    ...
                    <?php if (!empty($user->instagram) || !empty($user->website)): ?>
                        <div class="social-links">
                            <?php if (!empty($user->instagram)): ?>
                                <a href="<?= Html::encode($user->instagram) ?>" target="_blank" class="social-link instagram">
                            ...
                            <?php if (!empty($user->website)): ?>
                                <a href="<?= Html::encode($user->website) ?>" target="_blank" class="social-link website">
                                    <svg class="social-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <section class="history-section">
        <h3 class="section-title">Мои работы</h3>

        <?php if (empty($history)): ?>
            <div class="empty-state">Вы ещё не подавали работы на конкурсы</div>
        <?php else: ?>
...
<style>
    ...
    .page-subtitle { color: #6b6b80; font-size: 0.9rem; margin: 0; }
    ...
    .profile-details { flex: 1; min-width: 0; width: 100%; text-align: center; }
